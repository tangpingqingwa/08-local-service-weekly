...
The #1 **visible provider** for a city × category is whoever still occupies the rolling last-7-days window at rank `#1`. That is the product. Occupied and empty classified paper name that window. Empty copy does not present Monday 00:00 Europe/London as the drop.
