...
A public last-7-days auction for the **#1 visible local-service provider** in a **city × category**. Ranking is money. There are no stars, no review scores, and no “top rated” badges.
...
One-line pitch: **The #1 mover / dentist / immigration lawyer / tutor in town is whoever paid the most in the last 7 days.**
...
Checkout return page (`/return`) shows paid / cancelled / unknown. It does not invent a rank before the webhook (live) or fixture settle. Occupied Polar return after a raise names Polar charged only the difference, not a full rebid. Occupied cancelled Polar return after a raise names they still occupy at the old bid. An abandoned raise does not unlist. A new listing cancelled return still names no rank claimed / does not list. A new listing return still names listed at the bid.
